        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Modifica el rol y sus permisos asociados
                </p>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        @if($role->name === 'super-admin')
                            <p class="mt-1 text-xs text-yellow-600 dark:text-yellow-400">
                                El nombre del rol Super Admin no puede ser modificado.
                            </p>
                        @endif
                    </div>
                    ...
                    <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
                        <div class="flex items-center justify-between text-sm mb-2">
                            <span class="text-gray-600 dark:text-gray-400">Usuarios con este rol:</span>
                        ...
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <code class="text-xs bg-gray-200 dark:bg-gray-700 px-2 py-0.5 rounded">{{ $role->guard_name }}</code>
                        </div>
                    </div>
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                            ...
                            <div class="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800">
                                <div class="flex items-center gap-3">
                                    ...
                                    @php
                                        $modulePermissionIds = collect($moduleData['permissions'])->pluck('id')->toArray();
                                        $selectedInModule = count(array_intersect($selectedPermissions, $modulePermissionIds));
                                    @endphp
                                    <span class="text-xs text-gray-500 dark:text-gray-400">
                                        ({{ $selectedInModule }}/{{ count($moduleData['permissions']) }})
                                    </span>
                                </div>
                                <div class="flex gap-2">
                                    <button
